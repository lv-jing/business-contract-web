<template>
  <div>
    ...
    <div class="bg-white user-form-table pd24">
      <el-button type="primary" @click="recallApplication" icon="iconfont sbt_add">流程作废</el-button>
...
export default {
  data() {
    return {
      ...
      overHeight: "150px",
      ruleForm: {
        statue: "STA006,STA007,STA005,STA008,STA009"
      },
      rules: {},
      deletUrl: "",
      tableData: [],
