<template>
<div>
    <div id="contractTypeChart" class="echart2" :style="drawStyle" @click="showTableLevel"></div>
...
export default {
    ...
    methods:{
        ...
        queryData(){
            ...
            this.reportData = []
            this.legends = []
            reportApi.queryByContractTypePortrait(this.queryParams).then(res=>{
                if(res.code === '000000'){
                    this.dataTitle = []
                    this.reportData = []
                    this.legends = []
        ...
        drawLine(){
            ...
            let myChart = this.$echarts.init(document.getElementById('contractTypeChart'))
