<template>
    <div>
        <div id="contractPrintChart" class="echart2" :style="drawStyle" @click="showTableLevel"></div>
...
export default {
    ...
    methods:{
        ...
        queryData(){
            ...
            this.legends = []
            this.yData = []
            reportApi.queryByContractPrintOrder(this.queryParams).then(res=>{
                if(res.code === '000000'){
                    this.reportData = []
                    this.legends = []
                    this.yData = []
        ...
        drawLine(){
            ...
            let myChart = this.$echarts.init(document.getElementById('contractPrintChart'))
            ...
            myChart.setOption({
                ...
                color:['#2e76ca','#5dccd8','#5fcb9f', '#f5be51'],
