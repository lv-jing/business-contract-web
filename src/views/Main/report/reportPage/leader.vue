<template>
    <div class="report">
        ...
        <el-row>
            ...
            <el-col :span="12">
                <contractCountReport :queryParams="queryParams"></contractCountReport>
            </el-col>
            <el-col :span="12">
                <contractApprovalAllReport :queryParams="queryParams"></contractApprovalAllReport>
            </el-col>
        </el-row>
...
import contractCountReport from '../contractCountReport'
import contractApprovalAllReport from '../contractApprovalAllReport'
export default {
    data(){
        return {
            v_year:'',
            ...
            queryParams:{roleEnum: "GROUP_CHARGE_LEADER",}
        }
    },
    components:{
        ...
        contractCountReport:contractCountReport,
        contractApprovalAllReport:contractApprovalAllReport
    },
    created(){
