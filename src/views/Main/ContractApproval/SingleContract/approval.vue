      ...
      <el-col :span="19">
        <div class="bg-white">
          <el-card class="box-card" shadow="never">
            ...
            <div class="form-bg">
              <common-title title="基本信息" class="mb16"/>
...
<!--                    <el-col :span="6">-->
<!--                      <el-form-item label="合同流水" prop="serialNumber">-->
...
<!--                    </el-col>-->
                ...
                <el-row :gutter="24">
                  ...
                  <el-col :span="10" v-if="ruleForm.templateAttr!=='CTA003'" :offset="2">
                    <el-form-item label="合同范本" prop="modelNameList"
                      ...
                      <el-select
                        :disabled="ruleForm.templateAttr==='CTA003' || $route.query.taskKey!=='start'||$route.query.sourceType==='INAPPROPRIATEPROCESS'"
                        class="w-100"
                  ...
                  <el-col :span="10" v-else :offset="2">
                    <el-form-item label="合同场景" prop="contractScenario">
                      <el-select filterable
                                 :disabled="$route.query.taskKey!=='start'||$route.query.sourceType==='INAPPROPRIATEPROCESS'"
                                 v-model="ruleForm.contractScenario" class="w-100">
                        <el-option
                ...
                <el-row :gutter="24">
                  <el-col :span="10">
                    <el-form-item label="合同名称" prop="contractName">
                      <el-input
                        :disabled="$route.query.taskKey!=='start'||$route.query.sourceType==='INAPPROPRIATEPROCESS'||ruleForm.templateAttr!=='CTA003'"
                ...
                <el-row :gutter="24">
                  ...
                  <el-col :span="10" :offset="2">
                    <el-popover
                      ...
                      :disabled="$route.query.taskKey!=='start'||$route.query.sourceType==='INAPPROPRIATEPROCESS'"
                      content="请仔细核对签约主体的准确性，与营业执照（公司）/身份证（个人）的名称保持一致！">
                      <el-form-item label="对方主体" prop="orEntityCode" slot="reference" id="over-select">
                        <el-select multiple filterable @change="(val)=>sideChange1(val)"
                                   v-model="ruleForm.orEntityCode" ref="orentuty"
                                   remote allow-create @visible-change="setTagTitle"
                                   :disabled="$route.query.taskKey!=='start'||$route.query.sourceType==='INAPPROPRIATEPROCESS'"
                                   @focus="entityFocus(1)"
                ...
                <div v-if="ruleForm.incomeExpeTypeCode!=='IET004'&& moneyShow">
                  <el-row :gutter="24">
                    ...
                    <el-col :span="10" :offset="2">
                      <el-form-item disabled label="原币金额"
                    ...
                    <el-col :span="10" :offset="2">
                      <el-form-item label="合同税率" prop="taxRate">
                        <el-input type="number"
                                  :disabled="ruleForm.contractCurrencyCode !== '人民币'||$route.query.taskKey!=='start'||$route.query.sourceType==='INAPPROPRIATEPROCESS'"
                ...
                <el-row :gutter="24">
                  <el-col :span="10">
                    <el-form-item label="合同份数" prop="contractNumber">
                      <el-input
                        :disabled="$route.query.taskKey!=='start'||$route.query.sourceType==='INAPPROPRIATEPROCESS'"
                        type="number" @keydown.native="clearInput"
                        class="w-100 t-l" v-model.number="ruleForm.contractNumber"
                  ...
                  <el-col :span="10" :offset="2">
                    <el-form-item label="合同期限" prop="validDateType">
                      <common-select
                        :disabled="$route.query.taskKey!=='start'||$route.query.sourceType==='INAPPROPRIATEPROCESS' || (dateShow && ruleForm.templateAttr==='CTA001')"
                ...
                <el-row :gutter="24">
                  ...
                  <el-col :span="10" :offset="2">
                    <el-form-item label="年份数量" prop="validYear" v-if="ruleForm.validDateType==='2'"
                      ...
                      <el-input
                        :disabled="$route.query.taskKey!=='start'||$route.query.sourceType==='INAPPROPRIATEPROCESS'"
                        :min="0" type="number" @keydown.native="clearInput"
                          ...
                          <template v-for="item in ruleForm.uploadListOne">
                            ...
                            <el-col :span="12">
                              <div class="but-cont-style" style="margin-left: 2px;">
                                ...
                                <a v-if="$route.query.sourceType!=='INAPPROPRIATEPROCESS'"
                                  @click="editUploadClick(item,2)"
                ...
                <div class="border-top">
                  <common-title title="小工具-提醒" class="mt20 mb20" content="可在此处设置相关备忘或提醒哦"/>
                  <el-col :span="22">
                      <el-button
                        type="primary"
                        size="small"
...
import {getTableData, getText, OpenKgWindow, rand, setTableData, setUplod, clearInput} from "@/utils/tools";
...
export default {
  ...
  methods: {
    setTagTitle() {
      var tagTextList = document.querySelector('#over-select').querySelectorAll('.el-select__tags-text')
        ...
        if (val === 2) {
          if(atrr==='CTA001' || (atrr==='CTA002' && this.ruleForm.uploadListOne[0].fileStatus==='STA001')){
            ...
            if (this.ruleForm.uploadListOne[0].fileStatus === 'STA001') {
              OpenKgWindow('?openType=add&docFileName=' + encodeURIComponent(this.ruleForm.contractName) + '&isSave=true&operateType=contract&fileId=' + params + '&contractId=' + id + '&businessId=' + businessId + '&businessAttamentId=' + businessAttamentId + '&fileName=' + fileName + '&atrr=' + atrr + '&txtShow=' + txtShow + '&token=' + token)
            } else {
              OpenKgWindow('?openType=open&docFileName=' + encodeURIComponent(this.ruleForm.contractName) + '&isSave=true&operateType=contract&fileId=' + params + '&contractId=' + id + '&businessId=' + businessId + '&businessAttamentId=' + businessAttamentId + '&fileName=' + fileName + '&atrr=' + atrr + '&txtShow=' + txtShow + '&token=' + token)
            }
          }
        }
    ...
    // 获取合同范本的fildId
    async getFile() {
      const {taskKey,sourceType} =this.$route.query;
