...
import {getContractType, postEidtSing} from "@/service/approval";
import {formatSeconds, OpenKgWindow, setUplod} from '@/utils/tools'
...
export default {
  ...
  methods: {
    ...
    async postEidtSing() {
      ...
      if (code === '000000') {
        this.tableData = data.contractFulfillList || [];
